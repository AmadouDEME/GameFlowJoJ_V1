  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-bold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground shadow-glow hover:-translate-y-0.5 hover:shadow-deep",
        premium: "bg-accent text-accent-foreground shadow-soft hover:-translate-y-0.5 hover:shadow-glow",
        signal: "bg-destructive text-destructive-foreground shadow-soft hover:-translate-y-0.5",
      ...
      size: {
        ...
        icon: "h-10 w-10",
        xl: "h-13 rounded-xl px-7 py-4 text-base",
      },
    },
    defaultVariants: {
      variant: "default",
